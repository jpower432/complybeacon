...
const POLICY_EXCEPTION_APPROVED = "policy.exception.approved"

// Unique identifier for the approved policy exception, if applicable
const POLICY_EXCEPTION_ID = "policy.exception.id"
...
const POLICY_STATUS_MESSAGE = "policy.status.message"
