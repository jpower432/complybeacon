...
// Whether the exception was approved for this evaluation or enforcement
const COMPLIANCE_EXCEPTION_ACTIVE = "compliance.exception.active"

// Unique identifier for the approved exception, if applicable
const COMPLIANCE_EXCEPTION_ID = "compliance.exception.id"
