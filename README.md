...
An instrumentation library for consistently modeling evidence attributes.
...
# Test the pipeline
curl -X POST http://localhost:4318/eventsource/receiver -H "Content-Type: application/json" -d @hack/sampledata/evidence.json
```
